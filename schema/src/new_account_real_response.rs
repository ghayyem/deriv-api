...
// Source: ./deriv-api-docs/config/v3/new_account_real/receive.json
...
pub struct NewAccountRealResponse {
    ...
    #[serde(rename = "new_account_real", skip_serializing_if = "Option::is_none")]
    pub new_account_real: NewAccountReal,
