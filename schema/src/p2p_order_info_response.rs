...
pub struct P2pOrderInfoResponse {
    ...
    #[serde(rename = "p2p_order_info", skip_serializing_if = "Option::is_none")]
    pub p_2p_order_info: P2pOrderInfo,
...
pub struct P2pOrderInfo {
    ...
    #[serde(rename = "review_details", skip_serializing_if = "Option::is_none")]
    pub review_details: ReviewDetails,
