...
use crate::p2p_advertiser_payment_methods_value::P2pAdvertiserPaymentMethodsValue;
...
pub struct P2pAdvertiserPaymentMethodsResponse {
    ...
    pub p2p_advertiser_payment_methods: Option<HashMap<String, P2pAdvertiserPaymentMethodsValue>>,
