...
use crate::buy_contract_for_multiple_accounts::BuyContractForMultipleAccounts;
...
pub struct BuyContractForMultipleAccountsResponse {
    ...
    pub buy_contract_for_multiple_accounts: Option<BuyContractForMultipleAccounts>,
